...
window.onload = function() {
	...
	// for slidepazzle
	game.preload('slidepazzle/blank.png', 'slidepazzle/bottom_to_left.png', 'slidepazzle/bottom_to_right.png', 'slidepazzle/cross.png', 'slidepazzle/horizontal.png', 'slidepazzle/vertical.png', 'slidepazzle/top_to_left.png', 'slidepazzle/top_to_right.png', 'slidepazzle/no_road.png');
	...
	game.menuScene = function(){
        ...
        icon_slidepazzle.addEventListener(Event.TOUCH_START, function(e) {
            if(is_icon_ready == 1){
	...
	game.game3SelectScene = function() {
        game.fps = 30;
        var scene = new Scene();
    ...
    game.game3Scene = function() {
        game.fps = 30;
        var scene = new Scene();
        slidepazzle_start(game, scene);
        return scene;
    }
